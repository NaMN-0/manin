...
import { getAvatarById, getRandomAvatarId } from "../utils/ninjaAvatars";

export default function Navbar() {
  const { user, isPro, signOut } = useAuth();
  const { level, rank, xp, virtualCash } = useGame();
    ...
    <>
          ...
          >
                ...
                {showProTooltip && (
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <Zap size={10} color="#f59e0b" /> Real-time AI Scans
                      </li>
                      <li
                        style={{
                          display: "flex",
                      ...
                      >
                        <Zap size={10} color="#f59e0b" /> Unlimited Data
                      </li>
                      <li
                        style={{
                          display: "flex",
                      ...
                      >
                        <Zap size={10} color="#f59e0b" /> Priority Support
                      </li>
                    </ul>
                  </div>
                )}
            ...
            >
              ...
              >
                <div
                  style={{
                    width: `${xp % 100}%` /* Simplified 0-100 logic for bar */,
                    height: "100%",
            ...
            <button
              ...
              style={{
                display: "none",
                padding: 8,
                color: mobileOpen ? "var(--primary)" : "var(--text-secondary)",
                flexShrink: 0,
              }}
            >
      ...
      <div
        style={{
          position: "fixed",
          inset: 0,
          top: "calc(64px + var(--banner-height, 0px))",
          zIndex: 999,
