        ...
        <div className="page" style={{
            ...
            <div className="glass-card" style={{
                ...
                <div style={{
                    ...
                    <div style={{ position: 'absolute', inset: 0, borderRadius: '16px', background: 'radial-gradient(circle at center, rgba(14, 165, 233, 0.2) 0%, transparent 70%)' }} />
                ...
                <p style={{ color: 'var(--text-secondary)', marginBottom: 32, fontSize: 15, lineHeight: 1.6 }}>
                    Sign in to access penny stock intelligence<br />
