...
export default function TraderNinjaLogo({ className, style }) {
    return (
        ...
        >
            ...
            {/* Branding Pulse */}
            <circle cx="50" cy="50" r="45" stroke="url(#pulseGradient)" strokeWidth="1" opacity="0.5">
            ...
            <defs>
                ...
                <linearGradient id="pulseGradient" x1="0" y1="0" x2="100" y2="0" gradientUnits="userSpaceOnUse">
