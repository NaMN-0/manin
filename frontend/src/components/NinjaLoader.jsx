...
import { NinjaMeditating, NinjaCharting, NinjaRocket, NinjaValues, NinjaTeam } from './NinjaIllustrations';
...
export default function NinjaLoader({ variant = 'meditating' }) {
    ...
    const renderVisuals = () => {
        ...
        if (variant === 'penny') {
            return (
                <div className={isPoked ? 'shake' : ''} onClick={handlePoke} style={{ cursor: 'pointer' }}>
    ...
    return (
        <div style={{
            ...
            <div style={{
                fontSize: 18, fontWeight: 700, color: 'var(--amber)', marginBottom: 12,
            ...
            <div key={factIndex} style={{
                fontSize: 14, color: 'var(--text-secondary)', fontStyle: 'italic', maxWidth: 420,
                minHeight: 48, animation: 'factFade 0.5s ease-out'
            }}>
