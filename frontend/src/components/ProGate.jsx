...
export default function ProGate({
  ...
  // If blur mode is enabled, render the content with a blur filter and a CTA overlay
  if (blur) {
    return (
      <div style={{ position: "relative", width: "100%", height: "100%" }}>
        ...
        >
          ...
          <h4 style={{ fontSize: 16, fontWeight: 900, marginBottom: 4 }}>
            {title}
          </h4>
          <p
            style={{
          ...
          >
            Restore vision with Sensei Pro
          </p>
          <button
  ...
  async function handleSubscribe() {
    ...
    try {
      ...
      const rzpLoaded = await loadScript(
      ...
      >
        ...
        <div
          style={{
            padding: 48,
            background:
              "linear-gradient(135deg, rgba(14, 165, 233, 0.05) 0%, rgba(15, 23, 42, 0.4) 100%)",
            display: "flex",
            flexDirection: "column",
            justifyContent: "center",
            alignItems: "center",
        ...
        >
          ...
          >
            Join the elite circle of early adopters. Lifetime access to
        ...
        >
          ...
          <div style={{ marginBottom: 32 }}>
            ...
            <p style={{ fontSize: 13, color: "var(--text-muted)" }}>
              Limited time offer. Normal price ₹999/mo.
            </p>
          </div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
            ...
            >
              {loading ? (
                ...
                <>
                  <Zap size={20} fill="currentColor" /> Claim Early Bird Status
                </>
              )}
            </button>
